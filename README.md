...
published and from the MATLAB reference's stated behaviour. No third-party
source or data file is redistributed: the benchmark families it is measured on
are generated by `fka.instances`, and the MATLAB snapshot in `FK- B/` stays
